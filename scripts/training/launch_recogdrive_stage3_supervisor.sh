...
LAUNCH_RESOURCE_POLICY="${LAUNCH_RESOURCE_POLICY:-local_gpu_free}"
LAUNCH_GPU_LIST="${LAUNCH_GPU_LIST:-0,1,2,3,4,5,6,7}"
LAUNCH_GPU_MAX_MEM_USED_MB="${LAUNCH_GPU_MAX_MEM_USED_MB:-2000}"
LAUNCH_GPU_MAX_UTIL="${LAUNCH_GPU_MAX_UTIL:-5}"
LAUNCH_LOCK_FILE="${LAUNCH_LOCK_FILE:-${OUTPUTS_ROOT}/stage3_next_action_launch.lock}"
...
supervisor_args=(
  ...
  "--launch-resource-policy" "${LAUNCH_RESOURCE_POLICY}"
  "--launch-gpu-list" "${LAUNCH_GPU_LIST}"
  "--launch-gpu-max-mem-used-mb" "${LAUNCH_GPU_MAX_MEM_USED_MB}"
  "--launch-gpu-max-util" "${LAUNCH_GPU_MAX_UTIL}"
  "--launch-lock-file" "${LAUNCH_LOCK_FILE}"
...

{
  ...
  echo "launch_resource_policy=${LAUNCH_RESOURCE_POLICY}"
  echo "launch_gpu_list=${LAUNCH_GPU_LIST}"
  echo "launch_gpu_max_mem_used_mb=${LAUNCH_GPU_MAX_MEM_USED_MB}"
  echo "launch_gpu_max_util=${LAUNCH_GPU_MAX_UTIL}"
  echo "launch_lock_file=${LAUNCH_LOCK_FILE}"
