...
export GRPO_BUFFER_PREFERENCE_DPO_LABEL_SMOOTHING="${GRPO_BUFFER_PREFERENCE_DPO_LABEL_SMOOTHING:-0.0}"
export GRPO_BUFFER_PREFERENCE_DPO_REFERENCE_FREE="${GRPO_BUFFER_PREFERENCE_DPO_REFERENCE_FREE:-false}"
...
export GRPO_BUFFER_PREFERENCE_DPO_GAP_WEIGHT_MODE="${GRPO_BUFFER_PREFERENCE_DPO_GAP_WEIGHT_MODE:-none}"
export GRPO_BUFFER_PREFERENCE_DPO_GAP_WEIGHT_SCALE="${GRPO_BUFFER_PREFERENCE_DPO_GAP_WEIGHT_SCALE:-0.05}"
export GRPO_BUFFER_PREFERENCE_DPO_GAP_WEIGHT_MIN="${GRPO_BUFFER_PREFERENCE_DPO_GAP_WEIGHT_MIN:-0.0}"
export GRPO_BUFFER_PREFERENCE_DPO_GAP_WEIGHT_MAX="${GRPO_BUFFER_PREFERENCE_DPO_GAP_WEIGHT_MAX:-3.0}"
...
write_launch_summary() {
  {
    ...
    echo "grpo_buffer_preference_dpo_loss_schedule=${GRPO_BUFFER_PREFERENCE_DPO_LOSS_SCHEDULE}"
    echo "grpo_buffer_preference_dpo_loss_weight_start=${GRPO_BUFFER_PREFERENCE_DPO_LOSS_WEIGHT_START}"
    echo "grpo_buffer_preference_dpo_warmup_start_epoch=${GRPO_BUFFER_PREFERENCE_DPO_WARMUP_START_EPOCH}"
    echo "grpo_buffer_preference_dpo_warmup_epochs=${GRPO_BUFFER_PREFERENCE_DPO_WARMUP_EPOCHS}"
    echo "grpo_buffer_preference_dpo_timestep_sampling=${GRPO_BUFFER_PREFERENCE_DPO_TIMESTEP_SAMPLING}"
    echo "grpo_buffer_preference_dpo_beta=${GRPO_BUFFER_PREFERENCE_DPO_BETA}"
    echo "grpo_buffer_preference_dpo_label_smoothing=${GRPO_BUFFER_PREFERENCE_DPO_LABEL_SMOOTHING}"
    echo "grpo_buffer_preference_dpo_reference_free=${GRPO_BUFFER_PREFERENCE_DPO_REFERENCE_FREE}"
    echo "grpo_buffer_preference_dpo_pair_mode=${GRPO_BUFFER_PREFERENCE_DPO_PAIR_MODE}"
    echo "grpo_buffer_preference_dpo_min_reward_gap=${GRPO_BUFFER_PREFERENCE_DPO_MIN_REWARD_GAP}"
    echo "grpo_buffer_preference_dpo_max_pairs_per_scene=${GRPO_BUFFER_PREFERENCE_DPO_MAX_PAIRS_PER_SCENE}"
    echo "grpo_buffer_preference_dpo_gap_weight_mode=${GRPO_BUFFER_PREFERENCE_DPO_GAP_WEIGHT_MODE}"
    echo "grpo_buffer_preference_dpo_gap_weight_scale=${GRPO_BUFFER_PREFERENCE_DPO_GAP_WEIGHT_SCALE}"
    echo "grpo_buffer_preference_dpo_gap_weight_min=${GRPO_BUFFER_PREFERENCE_DPO_GAP_WEIGHT_MIN}"
    echo "grpo_buffer_preference_dpo_gap_weight_max=${GRPO_BUFFER_PREFERENCE_DPO_GAP_WEIGHT_MAX}"
    echo "grpo_buffer_preference_dpo_include_il=${GRPO_BUFFER_PREFERENCE_DPO_INCLUDE_IL}"
    ...
    echo "grpo_self_imitation_require_nc=${GRPO_SELF_IMITATION_REQUIRE_NC}"
    echo "grpo_self_imitation_require_dac=${GRPO_SELF_IMITATION_REQUIRE_DAC}"
    echo "grpo_self_imitation_require_ttc=${GRPO_SELF_IMITATION_REQUIRE_TTC}"
    echo "grpo_self_imitation_require_ddc=${GRPO_SELF_IMITATION_REQUIRE_DDC}"
    echo "grpo_self_imitation_nc_min_absolute=${GRPO_SELF_IMITATION_NC_MIN_ABSOLUTE}"
    echo "grpo_self_imitation_dac_min_absolute=${GRPO_SELF_IMITATION_DAC_MIN_ABSOLUTE}"
    echo "grpo_self_imitation_ttc_min_absolute=${GRPO_SELF_IMITATION_TTC_MIN_ABSOLUTE}"
    echo "grpo_self_imitation_ddc_min_absolute=${GRPO_SELF_IMITATION_DDC_MIN_ABSOLUTE}"
