...
AWAC_DDC_GUARD_MODE="${AWAC_DDC_GUARD_MODE:-relative_or_absolute}"
...
AWAC_TTC_GUARD_MODE="${AWAC_TTC_GUARD_MODE:-relative_or_absolute}"
...
AWAC_TIMESTEP_SAMPLING="${AWAC_TIMESTEP_SAMPLING:-uniform}"
AWAC_PREFERENCE_DPO_TIMESTEP_SAMPLING="${AWAC_PREFERENCE_DPO_TIMESTEP_SAMPLING:-${AWAC_TIMESTEP_SAMPLING}}"
AWAC_LOW_NOISE_TIMESTEP_FRAC="${AWAC_LOW_NOISE_TIMESTEP_FRAC:-0.35}"
AWAC_MID_NOISE_TIMESTEP_LOW_FRAC="${AWAC_MID_NOISE_TIMESTEP_LOW_FRAC:-0.15}"
AWAC_MID_NOISE_TIMESTEP_HIGH_FRAC="${AWAC_MID_NOISE_TIMESTEP_HIGH_FRAC:-0.65}"
AWAC_TARGET_BLEND_MODE="${AWAC_TARGET_BLEND_MODE:-none}"
AWAC_TARGET_BLEND_ALPHA="${AWAC_TARGET_BLEND_ALPHA:-1.0}"
AWAC_TARGET_BLEND_SCHEDULE="${AWAC_TARGET_BLEND_SCHEDULE:-constant}"
AWAC_TARGET_BLEND_ALPHA_START="${AWAC_TARGET_BLEND_ALPHA_START:-0.0}"
AWAC_TARGET_BLEND_WARMUP_START_EPOCH="${AWAC_TARGET_BLEND_WARMUP_START_EPOCH:-0}"
AWAC_TARGET_BLEND_WARMUP_EPOCHS="${AWAC_TARGET_BLEND_WARMUP_EPOCHS:-1}"
...
AWAC_PREFERENCE_DPO_LOSS_SCHEDULE="${AWAC_PREFERENCE_DPO_LOSS_SCHEDULE:-constant}"
AWAC_PREFERENCE_DPO_LOSS_WEIGHT_START="${AWAC_PREFERENCE_DPO_LOSS_WEIGHT_START:-0.0}"
AWAC_PREFERENCE_DPO_LOSS_WARMUP_START_EPOCH="${AWAC_PREFERENCE_DPO_LOSS_WARMUP_START_EPOCH:-0}"
AWAC_PREFERENCE_DPO_LOSS_WARMUP_EPOCHS="${AWAC_PREFERENCE_DPO_LOSS_WARMUP_EPOCHS:-1}"
AWAC_LOSS_WEIGHT="${AWAC_LOSS_WEIGHT:-1.0}"
AWAC_LOSS_SCHEDULE="${AWAC_LOSS_SCHEDULE:-constant}"
AWAC_LOSS_WEIGHT_START="${AWAC_LOSS_WEIGHT_START:-0.0}"
AWAC_LOSS_WARMUP_START_EPOCH="${AWAC_LOSS_WARMUP_START_EPOCH:-0}"
AWAC_LOSS_WARMUP_EPOCHS="${AWAC_LOSS_WARMUP_EPOCHS:-1}"
...
HYDRA_ARGS=(
  ...
  "agent.offline_rl_awac_timestep_sampling=${AWAC_TIMESTEP_SAMPLING}"
  "agent.offline_rl_preference_dpo_timestep_sampling=${AWAC_PREFERENCE_DPO_TIMESTEP_SAMPLING}"
  "agent.offline_rl_low_noise_timestep_frac=${AWAC_LOW_NOISE_TIMESTEP_FRAC}"
  "agent.offline_rl_mid_noise_timestep_low_frac=${AWAC_MID_NOISE_TIMESTEP_LOW_FRAC}"
  "agent.offline_rl_mid_noise_timestep_high_frac=${AWAC_MID_NOISE_TIMESTEP_HIGH_FRAC}"
  "agent.offline_rl_target_blend_mode=${AWAC_TARGET_BLEND_MODE}"
  "agent.offline_rl_target_blend_alpha=${AWAC_TARGET_BLEND_ALPHA}"
  "agent.offline_rl_target_blend_schedule=${AWAC_TARGET_BLEND_SCHEDULE}"
  "agent.offline_rl_target_blend_alpha_start=${AWAC_TARGET_BLEND_ALPHA_START}"
  "agent.offline_rl_target_blend_warmup_start_epoch=${AWAC_TARGET_BLEND_WARMUP_START_EPOCH}"
  "agent.offline_rl_target_blend_warmup_epochs=${AWAC_TARGET_BLEND_WARMUP_EPOCHS}"
  ...
  "agent.offline_rl_preference_dpo_loss_schedule=${AWAC_PREFERENCE_DPO_LOSS_SCHEDULE}"
  "agent.offline_rl_preference_dpo_loss_weight_start=${AWAC_PREFERENCE_DPO_LOSS_WEIGHT_START}"
  "agent.offline_rl_preference_dpo_loss_warmup_start_epoch=${AWAC_PREFERENCE_DPO_LOSS_WARMUP_START_EPOCH}"
  "agent.offline_rl_preference_dpo_loss_warmup_epochs=${AWAC_PREFERENCE_DPO_LOSS_WARMUP_EPOCHS}"
  "agent.offline_rl_awac_loss_weight=${AWAC_LOSS_WEIGHT}"
  "agent.offline_rl_awac_loss_schedule=${AWAC_LOSS_SCHEDULE}"
  "agent.offline_rl_awac_loss_weight_start=${AWAC_LOSS_WEIGHT_START}"
  "agent.offline_rl_awac_loss_warmup_start_epoch=${AWAC_LOSS_WARMUP_START_EPOCH}"
  "agent.offline_rl_awac_loss_warmup_epochs=${AWAC_LOSS_WARMUP_EPOCHS}"
  ...
  "agent.offline_rl_ddc_guard_mode=${AWAC_DDC_GUARD_MODE}"
  ...
  "agent.offline_rl_ttc_guard_mode=${AWAC_TTC_GUARD_MODE}"
...

{
  ...
  echo "awac_timestep_sampling=${AWAC_TIMESTEP_SAMPLING}"
  echo "awac_preference_dpo_timestep_sampling=${AWAC_PREFERENCE_DPO_TIMESTEP_SAMPLING}"
  echo "awac_low_noise_timestep_frac=${AWAC_LOW_NOISE_TIMESTEP_FRAC}"
  echo "awac_target_blend_mode=${AWAC_TARGET_BLEND_MODE}"
  echo "awac_target_blend_alpha=${AWAC_TARGET_BLEND_ALPHA}"
  echo "awac_target_blend_schedule=${AWAC_TARGET_BLEND_SCHEDULE}"
  echo "awac_target_blend_alpha_start=${AWAC_TARGET_BLEND_ALPHA_START}"
  echo "awac_target_blend_warmup_start_epoch=${AWAC_TARGET_BLEND_WARMUP_START_EPOCH}"
  echo "awac_target_blend_warmup_epochs=${AWAC_TARGET_BLEND_WARMUP_EPOCHS}"
  echo "awac_loss_weight=${AWAC_LOSS_WEIGHT}"
  ...
  echo "awac_preference_dpo_loss_schedule=${AWAC_PREFERENCE_DPO_LOSS_SCHEDULE}"
  echo "awac_preference_dpo_loss_weight_start=${AWAC_PREFERENCE_DPO_LOSS_WEIGHT_START}"
  echo "awac_preference_dpo_loss_warmup_start_epoch=${AWAC_PREFERENCE_DPO_LOSS_WARMUP_START_EPOCH}"
  echo "awac_preference_dpo_loss_warmup_epochs=${AWAC_PREFERENCE_DPO_LOSS_WARMUP_EPOCHS}"
  echo "awac_loss_schedule=${AWAC_LOSS_SCHEDULE}"
  echo "awac_loss_weight_start=${AWAC_LOSS_WEIGHT_START}"
  echo "awac_loss_warmup_start_epoch=${AWAC_LOSS_WARMUP_START_EPOCH}"
  echo "awac_loss_warmup_epochs=${AWAC_LOSS_WARMUP_EPOCHS}"
  ...
  echo "awac_ddc_guard_mode=${AWAC_DDC_GUARD_MODE}"
  echo "awac_ddc_min_absolute=${AWAC_DDC_MIN_ABSOLUTE}"
  echo "awac_ddc_max_relative_drop=${AWAC_DDC_MAX_RELATIVE_DROP}"
  echo "awac_require_ttc_guard=${AWAC_REQUIRE_TTC_GUARD}"
  echo "awac_ttc_guard_mode=${AWAC_TTC_GUARD_MODE}"
