...
CORR_ROOT="${OUT_ROOT}/highcap_no_risk_corruption"
mkdir -p "${CORR_ROOT}"
COMMANDS_LOG="${CORR_ROOT}/commands.log"

modes=(normal zero_all_cot zero_geometry_cot zero_dynamic_cot zero_ego_cot zero_action_refine_cot zero_coarse_prior drop_vlm_summary)
