...
| model | protocol | mean_PDMS | max_PDMS | min_PDMS | range_PDMS | feasible_rate | pairwise_ADE | Spread_AUC | safe_count |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| a5_sft | eval | 94.1732 | 95.3082 | 93.0961 | 2.2121 | 96.7516 | 0.0858 | 0.0892 | 15.4802 |
| a5_sft | native_grpo | 93.9975 | 96.9044 | 89.0878 | 7.8166 | 96.2625 | 0.3202 | 0.3211 | 15.4020 |
| official_il | eval | 92.1767 | 94.1775 | 88.8652 | 5.3123 | 93.9516 | 0.1449 | 0.1212 | 15.0322 |
| official_il | native_grpo | 69.2287 | 96.7185 | 21.9828 | 74.7357 | 69.0859 | 1.9955 | 1.5970 | 11.0538 |
| psi_sft | eval | 92.6015 | 96.1285 | 85.9754 | 10.1531 | 91.8719 | 0.3070 | 0.2504 | 14.6995 |
| psi_sft | native_grpo | 65.7064 | 97.4979 | 17.1058 | 80.3921 | 62.3641 | 2.2588 | 1.8071 | 9.9782 |
| v6_sft | eval | 93.7182 | 94.4629 | 93.0052 | 1.4577 | 96.7734 | 0.0830 | 0.0804 | 15.4838 |
| v6_sft | native_grpo | 93.5859 | 95.7853 | 90.0024 | 5.7829 | 96.4406 | 0.2666 | 0.2484 | 15.4305 |
...
- PSI：+0.162138，95%CI[0.158914, 0.165399]，n=1000。
- A5：-0.059029，95%CI[-0.064575, -0.053101]，n=1000。
- V6：-0.061859，95%CI[-0.066899, -0.056555]，n=1000。
...
| model | scenes | teacher_rows | teachers_per_scene | reconstructed_GT_mass_pre_budget |
| --- | --- | --- | --- | --- |
| a5_sft | 835 | 8578 | 10.2731 | 0.8834 |
| official_il | 835 | 835 | 1.0000 | 1.0000 |
| psi_sft | 835 | 1290 | 1.5449 | 0.2994 |
| v6_sft | 835 | 2092 | 2.5054 | 0.5395 |
...
| policy | protocol | scenes | teachers | weighted_hit16_0p5 | weighted_hit64_0p5 | weighted_hit64_1p0 | weighted_nearest_rollout_ADE |
| --- | --- | --- | --- | --- | --- | --- | --- |
| a5_sft | eval | 809 | 7748 | 19.5553 | 23.3212 | 46.9318 | 1.3985 |
| a5_sft | native_grpo | 809 | 7748 | 30.3126 | 44.2321 | 74.5076 | 0.7907 |
| psi_sft | eval | 767 | 962 | 8.8168 | 10.0391 | 35.8083 | 1.1176 |
| psi_sft | native_grpo | 767 | 962 | 0.0000 | 0.0000 | 13.6506 | 1.2405 |
| v6_sft | eval | 769 | 1257 | 2.4624 | 6.6487 | 41.9897 | 1.0298 |
| v6_sft | native_grpo | 769 | 1257 | 16.8228 | 38.6083 | 79.3047 | 0.6481 |
...
| policy | origin | scenes | weighted_epsilon_mse | weighted_hit64_0p5 |
| --- | --- | --- | --- | --- |
| a5_sft | a5_sft | 809 | 0.1620 | 0.2332 |
| a5_sft | official_il | 835 | 0.0309 | 0.9940 |
| a5_sft | psi_sft | 767 | 1.4595 | 0.0858 |
| a5_sft | v6_sft | 769 | 0.1427 | 0.0672 |
| official_il | a5_sft | 809 | 0.0254 | 0.2276 |
| official_il | official_il | 835 | 0.0018 | 0.9569 |
| official_il | psi_sft | 767 | 0.0363 | 0.0807 |
| official_il | v6_sft | 769 | 0.0127 | 0.0614 |
| psi_sft | a5_sft | 809 | 0.0174 | 0.2814 |
| psi_sft | official_il | 835 | 0.0056 | 0.8096 |
| psi_sft | psi_sft | 767 | 0.0225 | 0.1004 |
| psi_sft | v6_sft | 769 | 0.0105 | 0.2239 |
| v6_sft | a5_sft | 809 | 0.3127 | 0.2177 |
| v6_sft | official_il | 835 | 0.0583 | 0.9988 |
| v6_sft | psi_sft | 767 | 1.8683 | 0.0930 |
| v6_sft | v6_sft | 769 | 0.1453 | 0.0665 |

PSI相对official，在PSI非GT teacher上的加权epsilon loss差：-0.013736，95%CI[-0.018409, -0.009478]，n=767；在GT上的差：+0.003719，95%CI[0.003083, 0.004423]，n=835。必须同时看mean、median和正/负差scene比例，不能把平均改善说成每个teacher都改善。`paired_comparisons.csv`的历史字段名`win_fraction`仅表示差值>0的scene比例；对loss更小才是改善，对spread没有预定越大越好方向，不能直接把该字段解读为性能胜率。
...
**固定相同teacher库，比直接比较“各自teacher命中率”更可靠。** 普通推理、64次、0.5米标准下：A5自己的非GT teacher，official覆盖22.758%，A5覆盖23.321%；V6自己的teacher，official覆盖6.138%，V6覆盖6.649%。A5的配对增幅+0.005632，95%CI[-0.010396, 0.021499]，n=809；V6为+0.005109，95%CI[-0.015388, 0.025564]，n=769，两者CI都包含0。

PSI自己的teacher则从official的8.070%到PSI的10.039%，增幅+0.019687，95%CI[0.007234, 0.033248]，n=767，CI不含0。PSI还覆盖A5 teacher的28.139%、V6 teacher的22.390%，均高于对应从头SFT模型；共享并集消除了“各自teacher不同”这一直接比较的混杂，但不能消除训练架构与representation差异。
...
只切换eval floor与noise clip，保持checkpoint、初始及每步random numbers不变。`floor_only`、`clip_only`、`floor_and_clip`都事先冻结。both与native的逐轨迹最大绝对差为 **1.62124634e-05** 米/弧度（`metrics/factorial_parity.csv`）。这在本256场景直接检验了采样参数的作用，而不是从宽度相关性猜原因。

| model | protocol | mean_PDMS | pairwise_ADE | feasible_rate |
| --- | --- | --- | --- | --- |
| a5_sft | clip_only | 95.2284 | 0.2086 | 0.9763 |
| a5_sft | eval | 95.1149 | 0.0858 | 0.9773 |
| a5_sft | floor_and_clip | 94.8275 | 0.3161 | 0.9719 |
| a5_sft | floor_only | 94.9974 | 0.1696 | 0.9764 |
| a5_sft | native_grpo | 94.8275 | 0.3161 | 0.9719 |
| official_il | clip_only | 91.6784 | 0.2076 | 0.9282 |
| official_il | eval | 91.9352 | 0.1468 | 0.9317 |
| official_il | floor_and_clip | 69.8121 | 1.9966 | 0.6938 |
| official_il | floor_only | 77.9833 | 1.4603 | 0.7773 |
| official_il | native_grpo | 69.8121 | 1.9966 | 0.6938 |
| psi_sft | clip_only | 91.2673 | 0.5111 | 0.8972 |
| psi_sft | eval | 92.8878 | 0.3127 | 0.9235 |
| psi_sft | floor_and_clip | 66.0534 | 2.2610 | 0.6257 |
| psi_sft | floor_only | 77.7273 | 1.5524 | 0.7447 |
| psi_sft | native_grpo | 66.0534 | 2.2610 | 0.6257 |
| v6_sft | clip_only | 94.7802 | 0.1815 | 0.9760 |
| v6_sft | eval | 94.7548 | 0.0873 | 0.9760 |
| v6_sft | floor_and_clip | 94.5601 | 0.2749 | 0.9733 |
| v6_sft | floor_only | 94.6947 | 0.1608 | 0.9757 |
| v6_sft | native_grpo | 94.5601 | 0.2749 | 0.9733 |
...
| model | mean_PDMS | max_PDMS | min_PDMS | feasible_rate | pairwise_ADE | center_shift_IL_eval | center_shift_SFT_parent |
| --- | --- | --- | --- | --- | --- | --- | --- |
| a5_grpo_300 | 95.7822 | 98.9007 | 87.1028 | 92.4609 | 0.6787 | 1.7393 | 1.7588 |
| a5_grpo_4842 | 97.7349 | 99.1957 | 92.8854 | 95.5797 | 0.5098 | 2.0074 | 2.0155 |
| a5_sft | 93.9975 | 96.9044 | 89.0878 | 96.2625 | 0.3202 | 0.4489 | NA |
| official_il | 69.2287 | 96.7185 | 21.9828 | 69.0859 | 1.9955 | 0.1766 | NA |
| original_grpo_11970 | 79.0574 | 97.7626 | 30.8442 | 77.0484 | 1.9951 | 0.5235 | 0.4982 |
| psi_sft | 65.7064 | 97.4979 | 17.1058 | 62.3641 | 2.2588 | 0.5424 | NA |
| v6_grpo_300 | 94.6689 | 97.5445 | 88.6339 | 95.0531 | 0.3977 | 0.6181 | 0.6013 |
| v6_grpo_3300 | 95.3535 | 97.8591 | 87.6680 | 93.9266 | 0.3374 | 1.0166 | 1.0628 |
| v6_sft | 93.5859 | 95.7853 | 90.0024 | 96.4406 | 0.2666 | 0.4182 | NA |
...
- **original GRPO成功并不依赖native分布变窄。** native组均PDMS提升+9.828784，95%CI[9.104761, 10.565163]，n=1000；pairwise ADE变化-0.000457，95%CI[-0.001594, 0.000626]，n=1000，几乎不变。分布中心相对SFT移动约0.498米，可行率提升7.9625pp。相同的末步噪声尺度仍在，但中心/质量分配改善了。
- **A5/V6并非在训练分布上没有学到东西。** A5 step4842 native组均分提升+3.737447，95%CI[3.179078, 4.279957]，n=1000，V6 step3300为+1.767589，95%CI[1.215503, 2.292302]，n=1000。同时保守可行率分别下降0.6828pp/2.5141pp，中心移动约2.016米/1.063米，组内宽度增大。这支持“变得更积极，但安全保留不够”，不支持“完全没有梯度、策略不动”。
...
| model | protocol | scenes | positive_count | no_positive_group | all_zero | native_PIA | positive_above_reference_count |
| --- | --- | --- | --- | --- | --- | --- | --- |
| a5_grpo_4842 | native_grpo | 1000 | 4.3567 | 0.4435 | 0.0015 | 0.1156 | 3.8952 |
| a5_grpo_300 | native_grpo | 1000 | 4.0185 | 0.3935 | 0.0145 | 0.0489 | 3.2578 |
| v6_sft | native_grpo | 1000 | 2.6378 | 0.2923 | 0.0522 | 0.1339 | 0.3760 |
| v6_grpo_3300 | native_grpo | 1000 | 3.6208 | 0.3205 | 0.0027 | 0.1052 | 2.0585 |
| v6_grpo_300 | native_grpo | 1000 | 3.6267 | 0.2360 | 0.0215 | 0.1472 | 1.1370 |
| a5_sft | native_grpo | 1000 | 3.2835 | 0.2455 | 0.0328 | 0.1421 | 0.5975 |
