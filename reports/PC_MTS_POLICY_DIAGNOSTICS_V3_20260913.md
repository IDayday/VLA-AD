...
Fig-V3-1: [PNG](../outputs/pc_mts_diagnostics_v3/figures/Fig-V3-1_Gate_order.png) / [PDF](../outputs/pc_mts_diagnostics_v3/figures/Fig-V3-1_Gate_order.pdf)。

Fig-V3-2: [PNG](../outputs/pc_mts_diagnostics_v3/figures/Fig-V3-2_Quality_compatibility_frontier.png) / [PDF](../outputs/pc_mts_diagnostics_v3/figures/Fig-V3-2_Quality_compatibility_frontier.pdf)。

Fig-V3-3: [PNG](../outputs/pc_mts_diagnostics_v3/figures/Fig-V3-3_Matched_learnability.png) / [PDF](../outputs/pc_mts_diagnostics_v3/figures/Fig-V3-3_Matched_learnability.pdf)。

Fig-V3-4: [PNG](../outputs/pc_mts_diagnostics_v3/figures/Fig-V3-4_Gradient_interference.png) / [PDF](../outputs/pc_mts_diagnostics_v3/figures/Fig-V3-4_Gradient_interference.pdf)。

Fig-V3-5: [PNG](../outputs/pc_mts_diagnostics_v3/figures/Fig-V3-5_Micro_SFT_shift.png) / [PDF](../outputs/pc_mts_diagnostics_v3/figures/Fig-V3-5_Micro_SFT_shift.pdf)。
