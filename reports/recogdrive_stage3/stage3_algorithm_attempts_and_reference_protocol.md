...
| `stage3_grpo_refkl_s16_lr1e4_b2acc4_currentrepo_8gpu_20260614T191227Z` | running/evaluated epoch0+step1500 | This is not a new algorithm. It is a matched original-LR GRPO control on the current repository after AWAC/GRPO code changes: LR `1e-4`, sample_time `16`, BC `0.10->0.05`, ref KL `0.02`, no GSPO ratio, no hard gates, no buffer, no self-imitation. Epoch0-step1330 exact navtest PDMS is `0.893686`; step1500 is `0.891700`, so the best local point remains epoch0-step1330 and still trails the stronger zt3 current-code original-LR control epoch0-step1290 `0.896794`. Keep running as a control and compare future epochs at matched horizon. |
