...
日期：2026-09-21。分析分支 `analysis/grpo-credit-risk-quickcheck-20260921`；工作目录 `/mnt/project/VLA-AD-worktrees/grpo-credit-risk-quickcheck-20260921`。
统一产物：`/mnt/project/VLA-AD/outputs/grpo_credit_risk_quickcheck`。初始代码提交 `884ea1d0f67c60821d61033d61efb10916d16929`。最终提交通过 `git log -1` 查看。
...
|对象|真实文件|SHA256|
|---|---|---|
|SFT 父本|`/mnt/project/VLA-AD_last_vla_dev/outputs/stage2_pta_fs_dit_a5_full103k_standardv2_clean_20260710T091344Z/epoch_155.ckpt`|`79257dffba07792c77835aadd31e05bdab8c2f9afec75bc9772bac772a32e4b7`|
|早期 GRPO|`/mnt/project/VLA-AD_last_vla_dev/outputs/stage3_lfp_grpo_v1_exact_b8g16_epoch155_r4_20260712T083012Z/hydra/training_recogdrive_agent/stage3_lfp_grpo_v1_exact_b8g16_epoch155_r4_20260712T083012Z/step_checkpoints/step-step=300.ckpt`|`caf3aa73fdb3172e1b6257629914f66966ea980c9d0b7fe9e86c077aa49d162d`|

VLM：`/mnt/project/VLA-AD/checkpoints/recogdrive/ReCogDrive-VLM-2B`。FS standard-v2 统计、PTA/DiT 配置、全部顶层 VLM 权重/配置、reference cache 与 scorer 源码哈希见 `manifests/input_files.json`。归档 runtime commit `f350e56408584c0d375b1ff10744da2750442580`；runtime 在 `/mnt/project/VLA-AD/outputs/historical_sft_grpo_support/runtime/a5` 只读复用，未覆盖当前分支代码。
...
| model | protocol | metric | mean | low | high |
| --- | --- | --- | --- | --- | --- |
| a5_grpo_300 | deployment | all_infeasible | 0.000000 | 0.000000 | 0.000000 |
| a5_grpo_300 | deployment | mixed_feasible | 0.062500 | 0.036795 | 0.090918 |
| a5_grpo_300 | deployment | all_feasible | 0.937500 | 0.909445 | 0.962656 |
| a5_grpo_300 | deployment | all_full_pdms | 0.476562 | 0.411148 | 0.538153 |
| a5_grpo_300 | deployment | all_ep_saturated | 0.513672 | 0.452206 | 0.575208 |
| a5_grpo_300 | deployment | all_components_identical | 0.484375 | 0.421627 | 0.548332 |
| a5_grpo_300 | deployment | ep_only_components | 0.412109 | 0.349231 | 0.476794 |
| a5_grpo_300 | deployment | ep_only_identical_gates | 0.007812 | 0.000000 | 0.020080 |
| a5_grpo_300 | deployment | information_active | 0.484375 | 0.422000 | 0.546320 |
| a5_grpo_300 | deployment | positive_weighted_raw_progress_shift | 0.543377 | 0.444595 | 0.635142 |
| a5_grpo_300 | deployment | positive_weighted_end_speed_shift | 0.204834 | 0.158448 | 0.250602 |
| a5_grpo_300 | native_grpo | all_infeasible | 0.000000 | 0.000000 | 0.000000 |
| a5_grpo_300 | native_grpo | mixed_feasible | 0.119141 | 0.084581 | 0.156507 |
| a5_grpo_300 | native_grpo | all_feasible | 0.880859 | 0.842305 | 0.917309 |
| a5_grpo_300 | native_grpo | all_full_pdms | 0.429688 | 0.370075 | 0.490422 |
| a5_grpo_300 | native_grpo | all_ep_saturated | 0.484375 | 0.418967 | 0.549806 |
| a5_grpo_300 | native_grpo | all_components_identical | 0.419922 | 0.360000 | 0.482213 |
| a5_grpo_300 | native_grpo | ep_only_components | 0.419922 | 0.359126 | 0.481622 |
| a5_grpo_300 | native_grpo | ep_only_identical_gates | 0.005859 | 0.000000 | 0.015748 |
| a5_grpo_300 | native_grpo | information_active | 0.537109 | 0.473381 | 0.599222 |
| a5_grpo_300 | native_grpo | positive_weighted_raw_progress_shift | 0.623791 | 0.501008 | 0.739823 |
| a5_grpo_300 | native_grpo | positive_weighted_end_speed_shift | 0.253779 | 0.193096 | 0.312864 |
| a5_sft | deployment | all_infeasible | 0.000000 | 0.000000 | 0.000000 |
| a5_sft | deployment | mixed_feasible | 0.017578 | 0.003921 | 0.034091 |
| a5_sft | deployment | all_feasible | 0.982422 | 0.964583 | 0.996139 |
| a5_sft | deployment | all_full_pdms | 0.423828 | 0.359071 | 0.486331 |
| a5_sft | deployment | all_ep_saturated | 0.427734 | 0.360875 | 0.492400 |
| a5_sft | deployment | all_components_identical | 0.425781 | 0.360459 | 0.488768 |
| a5_sft | deployment | ep_only_components | 0.562500 | 0.497889 | 0.626954 |
| a5_sft | deployment | ep_only_identical_gates | 0.066406 | 0.037998 | 0.098083 |
| a5_sft | deployment | information_active | 0.503906 | 0.438518 | 0.567165 |
| a5_sft | deployment | positive_weighted_raw_progress_shift | 0.413800 | 0.264578 | 0.590694 |
| a5_sft | deployment | positive_weighted_end_speed_shift | 0.167346 | 0.096886 | 0.259004 |
| a5_sft | native_grpo | all_infeasible | 0.000000 | 0.000000 | 0.000000 |
| a5_sft | native_grpo | mixed_feasible | 0.050781 | 0.028337 | 0.075473 |
| a5_sft | native_grpo | all_feasible | 0.949219 | 0.925101 | 0.972628 |
| a5_sft | native_grpo | all_full_pdms | 0.384766 | 0.323214 | 0.447957 |
| a5_sft | native_grpo | all_ep_saturated | 0.396484 | 0.334782 | 0.461089 |
| a5_sft | native_grpo | all_components_identical | 0.384766 | 0.323413 | 0.446281 |
| a5_sft | native_grpo | ep_only_components | 0.576172 | 0.511716 | 0.638770 |
| a5_sft | native_grpo | ep_only_identical_gates | 0.027344 | 0.011537 | 0.047521 |
| a5_sft | native_grpo | information_active | 0.582031 | 0.517647 | 0.641395 |
| a5_sft | native_grpo | positive_weighted_raw_progress_shift | 0.985841 | 0.793180 | 1.196741 |
| a5_sft | native_grpo | positive_weighted_end_speed_shift | 0.372775 | 0.287223 | 0.472928 |
...
| protocol | metric | mean | low | high | scenes | logs |
| --- | --- | --- | --- | --- | --- | --- |
| deployment | PDMS | 0.014558 | 0.003016 | 0.025317 | 256 | 174 |
| deployment | NC | -0.002930 | -0.007967 | 0.000319 | 256 | 174 |
| deployment | DAC | -0.003540 | -0.009298 | 0.001049 | 256 | 174 |
| deployment | TTC | -0.032349 | -0.050398 | -0.016393 | 256 | 174 |
| deployment | EP | 0.072651 | 0.058632 | 0.086642 | 256 | 174 |
| deployment | raw_progress | 2.706111 | 2.342141 | 3.081098 | 256 | 174 |
| deployment | end_speed | 1.017055 | 0.852786 | 1.214911 | 256 | 174 |
| deployment | zero_score | 0.006470 | 0.000512 | 0.013760 | 256 | 174 |
| native_grpo | PDMS | 0.008960 | -0.003466 | 0.020798 | 256 | 174 |
| native_grpo | NC | -0.004150 | -0.008568 | -0.000492 | 256 | 174 |
| native_grpo | DAC | -0.003906 | -0.010913 | 0.002332 | 256 | 174 |
| native_grpo | TTC | -0.039673 | -0.057088 | -0.023662 | 256 | 174 |
| native_grpo | EP | 0.067274 | 0.053302 | 0.081502 | 256 | 174 |
| native_grpo | raw_progress | 2.767197 | 2.432425 | 3.127837 | 256 | 174 |
| native_grpo | end_speed | 1.019630 | 0.852222 | 1.205470 | 256 | 174 |
| native_grpo | zero_score | 0.007935 | 0.000875 | 0.015749 | 256 | 174 |
...
| protocol | split | safe_to_failure | failure_to_safe | ep_up_safety_improves |
| --- | --- | --- | --- | --- |
| deployment | calibration | 193 | 22 | 20 |
| deployment | confirmation | 318 | 33 | 33 |
| native_grpo | calibration | 272 | 73 | 69 |
| native_grpo | confirmation | 394 | 50 | 48 |
...
| scope | tolerance_m | scenes | matched_scene | matched_groups | total_groups | high_score_groups | matched_high_score_groups | all_group_coverage | high_score_group_coverage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| merged_two_groups | 0.250000 | 256 | 150.000000 | 297.000000 | 512.000000 | 344.000000 | 293.000000 | 0.580078 | 0.851744 |
| merged_two_groups | 0.500000 | 256 | 152.000000 | 301.000000 | 512.000000 | 344.000000 | 297.000000 | 0.587891 | 0.863372 |
| merged_two_groups | 1.000000 | 256 | 156.000000 | 309.000000 | 512.000000 | 344.000000 | 301.000000 | 0.603516 | 0.875000 |
| within_group | 0.250000 | 256 | 146.000000 | 286.000000 | 512.000000 | 344.000000 | 286.000000 | 0.558594 | 0.831395 |
| within_group | 0.500000 | 256 | 149.000000 | 293.000000 | 512.000000 | 344.000000 | 293.000000 | 0.572266 | 0.851744 |
| within_group | 1.000000 | 256 | 151.000000 | 295.000000 | 512.000000 | 344.000000 | 295.000000 | 0.576172 | 0.857558 |
...
| split | stream | draws | risk_events | NC_events | DAC_events | TTC_events |
| --- | --- | --- | --- | --- | --- | --- |
| calibration | evaluation_v1 | 4832 | 30.000000 | 2.000000 | 26.000000 | 6.000000 |
| calibration | selection_v1 | 4832 | 31.000000 | 2.000000 | 29.000000 | 4.000000 |
| confirmation | evaluation_v1 | 4704 | 42.000000 | 11.000000 | 24.000000 | 19.000000 |
| confirmation | selection_v1 | 4704 | 36.000000 | 8.000000 | 23.000000 | 15.000000 |
...
| comparator | metric | mean | low | high | scenes | logs |
| --- | --- | --- | --- | --- | --- | --- |
| A | evaluation_risk | -0.003985 | -0.007705 | -0.000880 | 149 | 112 |
| A | evaluation_NC_fail | -0.001258 | -0.003597 | 0.000000 | 149 | 112 |
| A | evaluation_DAC_fail | -0.002936 | -0.006250 | -0.000431 | 149 | 112 |
| A | evaluation_TTC_fail | -0.001258 | -0.003725 | 0.000000 | 149 | 112 |
| A | evaluation_hard_fail | -0.003985 | -0.008078 | -0.000963 | 149 | 112 |
| A | nominal_PDMS | -0.000541 | -0.000705 | -0.000395 | 149 | 112 |
| A | nominal_raw_progress | -0.032121 | -0.040636 | -0.023793 | 149 | 112 |
| A | nominal_end_speed | -0.015189 | -0.022834 | -0.007809 | 149 | 112 |
| A | evaluation_raw_progress | -0.032838 | -0.041629 | -0.024464 | 149 | 112 |
| B | evaluation_risk | -0.004824 | -0.009157 | -0.001458 | 149 | 112 |
| B | evaluation_NC_fail | -0.001468 | -0.003981 | 0.000000 | 149 | 112 |
| B | evaluation_DAC_fail | -0.003146 | -0.006466 | -0.000597 | 149 | 112 |
| B | evaluation_TTC_fail | -0.001888 | -0.004523 | 0.000000 | 149 | 112 |
| B | evaluation_hard_fail | -0.004404 | -0.008523 | -0.001275 | 149 | 112 |
| B | nominal_PDMS | 0.000041 | 0.000000 | 0.000107 | 149 | 112 |
| B | nominal_raw_progress | 0.000266 | -0.001762 | 0.002285 | 149 | 112 |
| B | nominal_end_speed | 0.001025 | -0.000718 | 0.003058 | 149 | 112 |
| B | evaluation_raw_progress | -0.000385 | -0.002496 | 0.001601 | 149 | 112 |
...
| stage | scope | sampled_candidates | nominal_candidate_scores | perturbation_candidate_scores | optimizer_updates |
| --- | --- | --- | --- | --- | --- |
| stage1_primary | two checkpoints,512 scenes,two native groups16 and two deployment pools16 | 65536 | 131072 | 0 | 0 |
| stage1_smoke_extra | repeat/capture draws plus repeated nominal and scoring-equivalence calls; PDM baseline excluded from candidate counts | 1536 | 6784 | 0 | 0 |
| stage2_matched_pairs | 1192 distinct selected candidates; 8 selection +8 evaluation | 0 | 1192 | 19072 | 0 |
| stage3_shared_step1 | two seeds shared by all four arms; costs are amortized, not charged four times | 2048 | 4096 | 16384 | 0 |
| stage3_update_attempt | seed=2026092111,arm=A; shared step1 cache reused; INVALID_STOPPED | 0 | 0 | 0 | 1 |
| stage3_update_attempt | seed=2026092111,arm=B; shared step1 cache reused; INVALID_STOPPED | 0 | 0 | 0 | 1 |
| stage3_update_attempt | seed=2026092111,arm=C; shared step1 cache reused; INVALID_STOPPED | 0 | 0 | 0 | 1 |
| stage3_update_attempt | seed=2026092111,arm=D; shared step1 cache reused; INVALID_STOPPED | 0 | 0 | 0 | 1 |
| stage3_update_attempt | seed=2026092112,arm=A; shared step1 cache reused; INVALID_STOPPED | 0 | 0 | 0 | 1 |
| stage3_update_attempt | seed=2026092112,arm=B; shared step1 cache reused; INVALID_STOPPED | 0 | 0 | 0 | 1 |
| stage3_update_attempt | seed=2026092112,arm=C; shared step1 cache reused; INVALID_STOPPED | 0 | 0 | 0 | 1 |
| stage3_update_attempt | seed=2026092112,arm=D; shared step1 cache reused; INVALID_STOPPED | 0 | 0 | 0 | 1 |
