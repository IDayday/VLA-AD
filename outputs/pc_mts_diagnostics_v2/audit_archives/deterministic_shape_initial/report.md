...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| gt_distance | 92.9505 | 85.7602 | 82.8981 | 0.9405 | 0.0278 | 0.4146 | 0.0285 | 4.6315 |
| pareto | 95.1033 | 90.0093 | 88.1468 | 0.9424 | 0.0184 | 0.4314 | 0.0197 | 3.2475 |
| pc_mts | 90.6695 | 81.5041 | 78.2209 | 0.9169 | 0.0439 | 0.3893 | 0.0357 | 5.8333 |
| score | 94.9408 | 88.9478 | 86.8096 | 0.9381 | 0.0218 | 0.4225 | 0.0241 | 3.8941 |
...
Full-1000 PC−Score radius=−0.03319m，95% CI=[−0.04064,−0.02576]；contrastive为−0.01661m，[−0.02473,−0.00882]。Local Feasible也分别低2.12和0.91个百分点。**本结果不支持“Score高分轨迹的robust basin比PC更窄”。**

仅比较共同的412个严格合格场景，PC radius=0.40550m、Score=0.41721m，方向仍未逆转。匹配每场景PC的raw parent数量，并令其他方法取相同数量的前缀后，PC−Score radius仍为−0.02982m；因此并非简单的16槽位重复计数才出现局部弱势。
...
V1保护清单在 `manifests/V1_IMMUTABLE_FILES.json`，最终哈希复核单独记录；未写入V1 outputs、CSV、checkpoint或报告。主实验没有删除场景；没有调整alpha、contrastive定义或q阈值去追求PC获胜；完整1000及不支持假说的结果均保留。
